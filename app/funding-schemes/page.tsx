...
const schemes: { tag: string; name: string; tagline: string; desc: string; href: string; highlight: boolean; Icon: IconType }[] = [
  ...
  { tag: "Infrastructure",  name: "Training Centre Fund",        tagline: "Establishment & infrastructure support",          desc: "Capital support for setting up PRIME-affiliated Training Centres across Meghalaya — equipping entrepreneurs and sector workers with practical skills through state-of-the-art training infrastructure.",                                                    href: "/funding-schemes",                highlight: false, Icon: HiHome },
